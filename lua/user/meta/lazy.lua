...
---@field lazy? boolean # Manually marks a plugin as optional.
...
---@field build? string | function | table # Post-update/install hook. See "update/install hooks".
---@field dependencies? string | (string | packer.PluginSpec)[] # Specifies plugin dependencies. See "dependencies".
