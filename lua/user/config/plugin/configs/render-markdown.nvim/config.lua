...
---@alias user.plugin.render_markdown.Preset
---| "obsidian" # mimic Obsidian UI                                          |
---| "lazy"     # will attempt to stay up to date with LazyVim configuration |
---| "none"     # does nothing                                               |

---@alias user.plugin.render_markdown.ElementType
---| "bullet"
---| "callout"
...
user.plugin.render_markdown = {
    ...
    ---@type user.plugin.render_markdown.Preset
    preset = "none",
    ...
    anti_conceal = {
        ...
        --   table_border
        --   virtual_lines
        ---@type table<user.plugin.render_markdown.ElementType, boolean>
        ignore = {
...
return user.plugin.render_markdown:with_wrap(function(value)
    require("render-markdown").setup(value)
end)
