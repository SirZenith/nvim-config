...
function M.load_autoload()
    local root_path = user.snippet.root_path()
    local snippet_dir = fs.normalize(root_path) .. "/auto-load"
...
function M.init_lazy_load()
    local root_path = user.snippet.root_path()
    local snippet_dir = fs.normalize(root_path) .. "/lazy-load"
    snippet_dir = vim.fn.fnamemodify(snippet_dir, ":p")
...
function M.init_conditional_load()
    local root_path = user.snippet.root_path()
    local snippet_dir = fs.normalize(root_path) .. "/conditional-load"
    snippet_dir = vim.fn.fnamemodify(snippet_dir, ":p")
